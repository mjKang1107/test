...
//ArrayList배열을 이용한 객체(데이터) 저장하기 연습 1
...
public class Test134 {
	public static void main(String[] args) {
		...
		list.add("홍길동");
		//위 ArrayList 가변길이 배열 공간에 123을 수동박싱 해서 추가
		list.add(new Integer(123));
		//위 ArrayList 가변길이 배열 공간에 3.14F를 수동박싱 해서 추가 
		...
		//iterator배열에 대한 객체(데이터)가 저장되어 있는 동안 반복해서 객체(데이터)를 꺼내와 사용함
