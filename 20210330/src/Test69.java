...
public class Test69 {
	...
	public static void main(String[] args) {
		...
		// 	 패키지명을 포함하는 경로명을 사용 해야 한다.
		// java.util.ArrayList arrayList; 가능
		// ArrayList arrayList2; 안됨!!
		...
		//InputStream객체의 역할
		//-> 채팅 시 데이터를 입력하면 
		//   바이트 단위로 데이터를 읽어 들이기 위한 스트림통로 역할을 한다.
		...
		//  Scanner객체의 next()메소드를 호출하여 문자열로 변환 후 반환 받아 출력
