...
public class Test70 {
	...
	public static void main(String[] args) {
		//1. 클래스 변수 y애 접근하여 출력하기
		//방법 : 객체 생성 없이 클래스명.클래스변수명
		System.out.println("클래스명.클래스변수명 = " + Test.y);
		
		//2. 인스턴스 변수 x를 객체 생성 없이 클래스명.인스턴스변수명으로 접근 불가능!!!
		...
		//결론:
		//static으로 선언된 클래스 변수에 접근 하는 방법
		//1.클래스명.클래스변수명 접근가능
		//2.객체생성 후 -> 참조변수명.클래스변수명 접근가능
		//---------------------------------------------------------------
		//---------------------------------------------------------------
		...
		//기존에 있던 클래스변수 y내부에 저장된 값이 계속 += 누적된다.(공용변수)
		...
		//클래스변수 y에 접근하여 클래스변수 y의 값 출력
		//방법2. 클래스명.클래스변수명;
		System.out.println(Test.y);
		//방법1. 참조변수명.클래스변수명;
		//System.out.println(t3.y3);
		
		/*
		 중요 결론:
		 1. 객체 단위로 메모리 할당하는 인스턴스변수(객체변수)는
		 	인스턴스(객체)개별적으로 따로 JVM메모리의 heap영역에
		 	할당하기때문에 개별적인 인스턴스변수로 10이 각각 저장됨
