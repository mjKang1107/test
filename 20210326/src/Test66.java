...
주제 : 같은 클래스 내부의 다른형태의 생성자를 호출하는 this()메소드 알아보기
...
class MyDate{
	...
	//객체생성시!! 객체변수 year,month,day의 값을 저장할 생성자
	...
	public void print() {
		System.out.println(this.year + "/" + this.month + "/" + day);
	}
...
public class Test66 {
	...
	public static void main(String[] args) {
		//1.객체 생성 동시에 1988,8,30 을 생성자 호출시 매개변수로 전달해 
		...
		d3.print();
		//4.객체 생성시 기본생성자 호출하여 각 객체 변수의 값들 초기화 (저장)
		...
		/*결론: MyDate클래스를 이용해 객체(인스턴스)를 생성할때
				...
				전달한 값이 매개변수 4개가 있는 생성자를 다시~ 호출하기 때문.
